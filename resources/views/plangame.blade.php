            ...
            <form class="hometab" method="POST" action="{{ route('gomytask') }}">
                ...
                <div class="form-group mt-50">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <input type="text" class="form-control text-24" name="playername" id="playername" placeholder="Input your player name" value="{{$gameInfo['playerName']}}" required autocomplete=off @error('playername') is-invalid @enderror maxlength="20"/>
                    </div>
                </div>
